...
parts = [
    ...
    "draw of +40.8% against a +15.8% truth. The bracket is the +/-1 sigma band, "
    "`geomean ×/÷ gsd` — printed rather than the geometric standard deviation itself, "
    "which is a multiplicative factor and would read as a symmetric interval if rendered "
    "as a percentage. A wide band means the metrics disagree and the headline number "
    "should not be quoted alone. Negative is faster, in all three numbers. "
    "`locator_click` is excluded because it "
