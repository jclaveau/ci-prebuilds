...
- [Open user rulings carried across sessions](open_user_rulings_carried_across_sessions.md) — tmp/scratch-mem deletion, fix140 branch+stashes, from_stage=playwright TP lever, #259 queue, snap branch RESOLVED (shipped #273); ask, don't decide
